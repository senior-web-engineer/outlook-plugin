const {
  ...
  Office.initialize = function (reason) {
	  ...
	  jQuery(document).ready(function(){
		  ...
		  ///////////////////////Account Setting//////////////////////////
		  $('button.change_account').on("click", function(){
		  ...
		  $('button.logout_account').on("click", function(){
			  console.log($('button.ms-Dialog-button', parent.document),'2222222')
			  $('button.ms-Dialog-button', parent.document).click();
